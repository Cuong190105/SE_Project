...
class ForgotpasswordScreenDesktop extends StatefulWidget {
  const ForgotpasswordScreenDesktop({super.key});

  @override
  State<ForgotpasswordScreenDesktop> createState() =>
      _ForgotpasswordScreenDesktopState();
}

class _ForgotpasswordScreenDesktopState extends State<ForgotpasswordScreenDesktop> {
