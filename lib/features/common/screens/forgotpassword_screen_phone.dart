...
class ForgotpasswordScreenPhone extends StatefulWidget {
  ...
  @override
  State<ForgotpasswordScreenPhone> createState() => _ForgotpasswordScreenPhoneState();
}
        ...
        child: SafeArea(
          child: Center(
            child: SingleChildScrollView(
              padding: const EdgeInsets.all(16), // Giảm padding cho di động
              child: Column(
                children: [
                  Container(
                    ...
                    child: Icon(
                      Icons.lock_reset,
                      size: 48, // Giảm kích thước cho di động
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 24, // Giảm font cho di động
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'Mã OTP đã được gửi tới ${_savedEmail}',
          ...
          PinCodeTextField(
            ...
            pinTheme: PinTheme(
              ...
              borderRadius: BorderRadius.circular(8),
              fieldHeight: 40, // Giảm kích thước
              fieldWidth: 36,
