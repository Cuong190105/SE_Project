...
import 'package:eng_dictionary/features/common/widgets/translate/custom_text_selection_controls.dart';
                    ...
                    child: Listener(
                      onPointerDown: (event) {
                        ...
                        if (event.kind == PointerDeviceKind.mouse &&
                          ...
                          _isRightClick = true; // Flag to indicate right-click was pressed
                        }
                      },
                      onPointerUp: (event) async {
                        // Only show the menu if it was a right-click
                        if (_isRightClick && event.kind == PointerDeviceKind.mouse) {
                          ...
                          final value = await showMenu<String>(
                            ...
                            items: const [
                              PopupMenuItem<String>(value: 'cut', child: Text('Cắt')),
                              PopupMenuItem<String>(value: 'copy', child: Text('Sao chép')),
                              PopupMenuItem<String>(value: 'paste', child: Text('Dán')),
                              PopupMenuItem<String>(value: 'selectAll', child: Text('Chọn toàn bộ')),
                              PopupMenuItem<String>(value: 'translate', child: Text('Dịch')),
                            ],
                          );
                          ...
                          switch (value) {
                            case 'cut':
                              if (selection.isValid && !selection.isCollapsed) {
                                ...
                                controller.text =
                                    selection.textBefore(text) + selection.textAfter(text);
